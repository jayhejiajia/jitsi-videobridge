...
public class BitrateController
{
     ...
     * rank/priority of an endpoint that is based on the speaker rank of an
     * endpoint and it's video constraints. See {@link EndpointMultiRanker} for
     * more information on how the ranking works.
     */
